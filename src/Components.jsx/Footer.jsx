function Footer(){
    return(
        <>
       <div class="container  ">
        <div class="bg-[#CE794D] flex justify-center gap-20 py-6 w-full  shadow-lg flex-col md:flex-row p-10">
          <img src="img/logo.png" alt="" />
   
        </div>
   {/* <!-- links --> */}
   <div class="links flex bg-[#CE794D] pl-32 gap-6 md:gap-10 py-6 w-full  shadow-lg text-white flex-col md:flex-row ">
